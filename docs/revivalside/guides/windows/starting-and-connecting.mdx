...
The following guides assume you have followed the [installation guide](../../setup/installation). Navigate to the "Home" tab in the launcher to find the options for starting and stopping the server.
