...
![](./assets/extract-packets-success.webp)
...
After importing your account data, you can launch the [User Manager](../../references/user-manager.mdx) to ensure your data was imported correctly.
...
Open the [User Manager](../../references/user-manager.mdx) by clicking on the "User Manager" button in the launcher. This will allow you to view and manage account data on RevivalSide.
