...
<Video src="https://youtu.be/c986e__7XBw" />
...
<Callout type="warn">Ensure you have CounterSide closed before starting the packet capture process.</Callout>
...
After logging in, head back to the RevivalSide launcher, press "Finish and Export".

![](./assets/finish-and-export.webp)

If it was successful, you should see a `JOIN_LOBBY_ACK-XXXXXXXX.json` file in folder that was opened. Alternatively, you can check the "RESULT" section for the following:
...
After you have confirmed that the capture was successful, click on the "Import Captured Profile" button and wait for it to finish.

![](./assets/import-capture-btn.webp)

If it was successful, you should see a `users-XXXXXXXX.json` file in the same folder. Now you can [start RevivalSide](./starting-and-connecting.mdx) and your account data should be imported.
