...
On the [User Manager](../../references/user-manager.mdx) page, you will see a list of accounts. Select the account you want to save and click on the "Export file" button on the bottom.
