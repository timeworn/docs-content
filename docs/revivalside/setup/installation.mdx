...
<Video src="https://youtu.be/s7L2ZRLBKZc" />
...
<Callout type="warn">
  Freezing the client will copy the entire CounterSide folder (~16gb)
</Callout>
...
<Callout>
  This file is found in the `CounterSide\Data\Managed` folder of your
  CounterSide installation.
</Callout>
...
<Callout type="idea">
  You can check the progress of "Freeze Selected Client" in the "Logs" tab of
  the launcher. This also applies to other processes such as starting the server
  and wiki.
</Callout>
